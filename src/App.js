  ...
  return (
    ...
    <section className="welcome-area">
        <div className="welcome-slides owl-carousel">
            ...
            <div className="single-welcome-slide bg-img bg-overlay jarallax"
            style={{'backgroundImage': "url('img/bg-img/45.jpg')"}}>
            ...
            <div className="row">
                ...
                <div className="col-12">
                    <div className="more-speaker-btn text-center mt-20 mb-40 wow fadeInUp" data-wow-delay="300ms">
                        <a className="btn confer-btn-white" href="/#">view all Speaker <i
                                className="zmdi zmdi-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
                    ...
                    <div className="schedule-tab">
                        ...
                        <ul className="nav nav-tabs wow fadeInUp" data-wow-delay="300ms" id="conferScheduleTab"
                            ...
                            <li className="nav-item">
                                <a className="nav-link active" id="monday-tab" data-toggle="tab" href="#step-one" role="tab"
                                    aria-controls="step-one" aria-expanded="true">Monday <br/> <span>January 14,
                                        2019</span></a>
                            </li>

                            <li className="nav-item">
                                <a className="nav-link" id="tuesday-tab" data-toggle="tab" href="#step-two" role="tab"
                        ...
                        <div className="tab-pane fade show active" id="step-one" role="tabpanel"
                            ...
                            <div className="single-tab-content">
                                <div className="row">
                                    ...
                                    <div className="col-12">
                                        <div className="more-schedule-btn text-center mt-50 wow fadeInUp"
                                            data-wow-delay="300ms">
            ...
            <div className="row">
                ...
                <div className="col-12 col-lg-4">
                    <div className="single-ticket-pricing-table text-center mb-100 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <a href="/#" className="btn confer-btn w-100 mb-30">Get Tickets <i
                                className="zmdi zmdi-long-arrow-right"></i></a>
                ...
                <div className="col-12 col-md-6 col-lg-4">
                    <div className="single-ticket-pricing-table active text-center mb-100 wow fadeInUp"
                        data-wow-delay="300ms">
            ...
            <div className="row justify-content-between">
                <div className="col-12 col-sm-3">
                    <div className="contact-information mb-100">
                        ...
                        <div className="single-contact-info wow fadeInUp" data-wow-delay="300ms">
                            <p>Email:</p>
                            <h6><a href="" className="__cf_email__"
                                    data-cfemail="1f7c7071797a6d5f78727e7673317c7072">[email&#160;protected]</a></h6>
                        </div>
                            ...
                            <form action="" method="post" id="main_contact_form">
                                <div className="contact_input_area">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-lg-6">
                                            <div className="form-group">
                                                <input type="text" className="form-control mb-30" name="name" id="name2"
                                        ...
                                        <div className="col-12 col-lg-6">
                                            <div className="form-group">
                                                <input type="email" className="form-control mb-30" name="email" id="email"
                                                    placeholder="E-mail"/>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-12">
                                            <div className="form-group">
                                                <textarea name="message" className="form-control mb-30" id="message"
